...
describe Commission do
    it "should create a new commission" do
        car = Car.new(1, 2000, 10)
        rental = Rental.new(1, 1, '2015-12-8', '2015-12-8', 100)
        commission = Commission.new(rental)
        expect(commission.rental).to eq(rental)
    end
    ...
    it 'should calculate the total commission' do
        ...
        rental.calculate_price
        commission = Commission.new(rental)
        expect(commission.calculate_total_commission).to eq(900)
    end
    ...
    it 'should calculate the insurance commission' do
        ...
        rental.calculate_price
        commission = Commission.new(rental)
        expect(commission.calculate_insurance_commission).to eq(450)
    end
    ...
    it 'should calculate the road assistance fee' do
        ...
        rental.calculate_price
        commission = Commission.new(rental)
        expect(commission.calculate_road_assistance_fee).to eq(100)
    end
    ...
    it 'should calculate the drivy commissions' do
        ...
        rental.calculate_price
        commission = Commission.new(rental)
        expect(commission.calculate_drivy_commission).to eq(350)
    end
end