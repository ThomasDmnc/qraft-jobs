...
class Database
    ...
    def export_results_to_file
        ...
        @rentals.each do |rental|
            ...
            rentals << { id: rental.id, price: rental.total_price, commission: {insurance_fee: commission.calculate_insurance_commission, assistance_fee: commission.calculate_road_assistance_fee, drivy_fee: commission.calculate_drivy_commission}}
        end
